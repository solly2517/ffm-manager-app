...
export default function Home() {
  ...
  const summaryQuery = trpc.reports.summary.useQuery(undefined, { enabled: isAuthenticated && active === "reports" });
