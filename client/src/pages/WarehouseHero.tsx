...
export default function WarehouseHero() {
  ...
  const assignmentStatus = trpc.operations.warehouseHeroAssignmentStatus.useQuery(undefined, { enabled: isAuthenticated && user?.role === "warehouse_hero" });
